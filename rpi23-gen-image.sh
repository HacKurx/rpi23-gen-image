...
PASSWORD=${PASSWORD:=framboise}
USER_PASSWORD=${USER_PASSWORD:=framboise}
...
XKB_LAYOUT=${XKB_LAYOUT:="fr"}
XKB_VARIANT=${XKB_VARIANT:="latin9"}
...
ENABLE_NONFREE=${ENABLE_NONFREE:=true}
